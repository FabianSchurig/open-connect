...
3. **Edge Agent** — a Rust daemon that pulls signed manifests, executes modular update steps, manages A/B partitions and GRUB, and reports back over NATS.

The complete requirements catalogue lives at:

- [Functional Requirements](../requirements/functional.md) (FR-01 … FR-22)
- [Non-Functional Requirements](../requirements/non-functional.md) (NFR-01 … NFR-14)
...
Secondary goals (still mandatory but subordinate when conflicts arise): cloud-agnostic portability, RBAC, low-latency local communication for robotics.
